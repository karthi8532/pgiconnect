...
class Appcolor {
  //static const Color primary = Color(0xff13b2ba);
  static const Color primary = Color(0xffefc84a);
  ...
  static const Color buttoncolor = Color(0xff2e2c73);
  static const Color mainFontColor = Color(0xff2e2c73);
